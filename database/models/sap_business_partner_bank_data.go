...
func (r *sapBusinessPartnerBankDatumR) GetBusinessPartnerSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapBusinessPartnerBankData(mods ...qm.QueryMod) sapBusinessPartnerBankDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_bank_data`.*"})
	}

	return sapBusinessPartnerBankDatumQuery{q}
}
