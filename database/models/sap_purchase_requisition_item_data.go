...
func (r *sapPurchaseRequisitionItemDatumR) GetPurchaseRequisitionSapPurchaseRequisitionHeaderDatum() *SapPurchaseRequisitionHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapPurchaseRequisitionItemData(mods ...qm.QueryMod) sapPurchaseRequisitionItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_requisition_item_data`.*"})
	}

	return sapPurchaseRequisitionItemDatumQuery{q}
}
