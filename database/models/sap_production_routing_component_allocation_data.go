...
var (
	...
	sapProductionRoutingComponentAllocationDatumGeneratedColumns      = []string{}
)
...
func SapProductionRoutingComponentAllocationData(mods ...qm.QueryMod) sapProductionRoutingComponentAllocationDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_routing_component_allocation_data`.*"})
	}

	return sapProductionRoutingComponentAllocationDatumQuery{q}
}
