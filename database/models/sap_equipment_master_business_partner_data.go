...
func (r *sapEquipmentMasterBusinessPartnerDatumR) GetEquipmentSapEquipmentMasterEquipmentDatum() *SapEquipmentMasterEquipmentDatum {
	if r == nil {
		return nil
	}
	return r.EquipmentSapEquipmentMasterEquipmentDatum
}
...
func (o *SapEquipmentMasterBusinessPartnerDatum) EquipmentSapEquipmentMasterEquipmentDatum(mods ...qm.QueryMod) sapEquipmentMasterEquipmentDatumQuery {
	...
	return SapEquipmentMasterEquipmentData(queryMods...)
}
...
func SapEquipmentMasterBusinessPartnerData(mods ...qm.QueryMod) sapEquipmentMasterBusinessPartnerDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_equipment_master_business_partner_data`.*"})
	}

	return sapEquipmentMasterBusinessPartnerDatumQuery{q}
}
