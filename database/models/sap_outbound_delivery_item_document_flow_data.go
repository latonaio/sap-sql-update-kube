...
func (r *sapOutboundDeliveryItemDocumentFlowDatumR) GetPrecedingDocumentSapOutboundDeliveryHeaderDatum() *SapOutboundDeliveryHeaderDatum {
	if r == nil {
		return nil
	}
	return r.PrecedingDocumentSapOutboundDeliveryHeaderDatum
}
...
var (
	...
	sapOutboundDeliveryItemDocumentFlowDatumGeneratedColumns      = []string{}
)
...
func SapOutboundDeliveryItemDocumentFlowData(mods ...qm.QueryMod) sapOutboundDeliveryItemDocumentFlowDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_outbound_delivery_item_document_flow_data`.*"})
	}

	return sapOutboundDeliveryItemDocumentFlowDatumQuery{q}
}
