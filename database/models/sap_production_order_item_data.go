...
func (r *sapProductionOrderItemDatumR) GetManufacturingOrderSapProductionOrderGeneralDatum() *SapProductionOrderGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductionOrderItemData(mods ...qm.QueryMod) sapProductionOrderItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_order_item_data`.*"})
	}

	return sapProductionOrderItemDatumQuery{q}
}
