...
func (r *sapSalesSchedulingAgreementItemDeliveryScheduleDatumR) GetSalesSchedulingAgreementSapSalesSchedulingAgreementHeaderDatum() *SapSalesSchedulingAgreementHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapSalesSchedulingAgreementItemDeliveryScheduleData(mods ...qm.QueryMod) sapSalesSchedulingAgreementItemDeliveryScheduleDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_scheduling_agreement_item_delivery_schedule_data`.*"})
	}

	return sapSalesSchedulingAgreementItemDeliveryScheduleDatumQuery{q}
}
