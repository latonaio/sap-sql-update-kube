...
func (r *sapInboundDeliveryHeaderDatumR) GetDeliveryDocumentSapInboundDeliveryItemData() SapInboundDeliveryItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.DeliveryDocumentSapInboundDeliveryItemData
}

func (r *sapInboundDeliveryHeaderDatumR) GetSDDocumentSapInboundDeliveryPartnerData() SapInboundDeliveryPartnerDatumSlice {
	if r == nil {
		return nil
	}
	return r.SDDocumentSapInboundDeliveryPartnerData
}
...
func (o *SapInboundDeliveryHeaderDatum) DeliveryDocumentSapInboundDeliveryItemData(mods ...qm.QueryMod) sapInboundDeliveryItemDatumQuery {
	...
	return SapInboundDeliveryItemData(queryMods...)
}
...
func (o *SapInboundDeliveryHeaderDatum) SDDocumentSapInboundDeliveryPartnerData(mods ...qm.QueryMod) sapInboundDeliveryPartnerDatumQuery {
	...
	return SapInboundDeliveryPartnerData(queryMods...)
}
...
func SapInboundDeliveryHeaderData(mods ...qm.QueryMod) sapInboundDeliveryHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_inbound_delivery_header_data`.*"})
	}

	return sapInboundDeliveryHeaderDatumQuery{q}
}
