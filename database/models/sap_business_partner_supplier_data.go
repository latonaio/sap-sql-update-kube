...
func (r *sapBusinessPartnerSupplierDatumR) GetSupplierSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapBusinessPartnerSupplierData(mods ...qm.QueryMod) sapBusinessPartnerSupplierDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_supplier_data`.*"})
	}

	return sapBusinessPartnerSupplierDatumQuery{q}
}
