...
func (r *sapBusinessPartnerAddressDatumR) GetBusinessPartnerSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
var (
	...
	sapBusinessPartnerAddressDatumGeneratedColumns      = []string{}
)
...
func SapBusinessPartnerAddressData(mods ...qm.QueryMod) sapBusinessPartnerAddressDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_address_data`.*"})
	}

	return sapBusinessPartnerAddressDatumQuery{q}
}
