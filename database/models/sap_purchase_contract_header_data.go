...
func (r *sapPurchaseContractHeaderDatumR) GetPurchaseContractSapPurchaseContractAddressData() SapPurchaseContractAddressDatumSlice {
	if r == nil {
		return nil
	}
	return r.PurchaseContractSapPurchaseContractAddressData
}

func (r *sapPurchaseContractHeaderDatumR) GetPurchaseContractSapPurchaseContractItemConditionData() SapPurchaseContractItemConditionDatumSlice {
	if r == nil {
		return nil
	}
	return r.PurchaseContractSapPurchaseContractItemConditionData
}

func (r *sapPurchaseContractHeaderDatumR) GetPurchaseContractSapPurchaseContractItemData() SapPurchaseContractItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.PurchaseContractSapPurchaseContractItemData
}
...
func (o *SapPurchaseContractHeaderDatum) PurchaseContractSapPurchaseContractAddressData(mods ...qm.QueryMod) sapPurchaseContractAddressDatumQuery {
	...
	return SapPurchaseContractAddressData(queryMods...)
}
...
func (o *SapPurchaseContractHeaderDatum) PurchaseContractSapPurchaseContractItemConditionData(mods ...qm.QueryMod) sapPurchaseContractItemConditionDatumQuery {
	...
	return SapPurchaseContractItemConditionData(queryMods...)
}
...
func (o *SapPurchaseContractHeaderDatum) PurchaseContractSapPurchaseContractItemData(mods ...qm.QueryMod) sapPurchaseContractItemDatumQuery {
	...
	return SapPurchaseContractItemData(queryMods...)
}
...
func SapPurchaseContractHeaderData(mods ...qm.QueryMod) sapPurchaseContractHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_contract_header_data`.*"})
	}

	return sapPurchaseContractHeaderDatumQuery{q}
}
