...
func (r *sapSalesQuotationHeaderDatumR) GetSalesQuotationSapSalesQuotationHeaderPartnerData() SapSalesQuotationHeaderPartnerDatumSlice {
	if r == nil {
		return nil
	}
	return r.SalesQuotationSapSalesQuotationHeaderPartnerData
}

func (r *sapSalesQuotationHeaderDatumR) GetSalesQuotationSapSalesQuotationItemData() SapSalesQuotationItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.SalesQuotationSapSalesQuotationItemData
}
...
func (o *SapSalesQuotationHeaderDatum) SalesQuotationSapSalesQuotationHeaderPartnerData(mods ...qm.QueryMod) sapSalesQuotationHeaderPartnerDatumQuery {
	...
	return SapSalesQuotationHeaderPartnerData(queryMods...)
}
...
func SapSalesQuotationHeaderData(mods ...qm.QueryMod) sapSalesQuotationHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_quotation_header_data`.*"})
	}

	return sapSalesQuotationHeaderDatumQuery{q}
}
