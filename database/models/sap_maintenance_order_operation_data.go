...
func (r *sapMaintenanceOrderOperationDatumR) GetMaintenanceOrderSapMaintenanceOrderHeaderDatum() *SapMaintenanceOrderHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapMaintenanceOrderOperationData(mods ...qm.QueryMod) sapMaintenanceOrderOperationDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_order_operation_data`.*"})
	}

	return sapMaintenanceOrderOperationDatumQuery{q}
}
