...
func SapProductionOrderConfirmationMaterialMovementsData(mods ...qm.QueryMod) sapProductionOrderConfirmationMaterialMovementsDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_order_confirmation_material_movements_data`.*"})
	}

	return sapProductionOrderConfirmationMaterialMovementsDatumQuery{q}
}
