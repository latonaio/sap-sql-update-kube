...
func (r *sapPurchaseOrderHeaderDataWithAddressR) GetPurchaseOrderSapPurchaseOrderItemAccountData() SapPurchaseOrderItemAccountDatumSlice {
	if r == nil {
		return nil
	}
	return r.PurchaseOrderSapPurchaseOrderItemAccountData
}

func (r *sapPurchaseOrderHeaderDataWithAddressR) GetPurchaseOrderSapPurchaseOrderItemDataWithAddresses() SapPurchaseOrderItemDataWithAddressSlice {
	if r == nil {
		return nil
	}
	return r.PurchaseOrderSapPurchaseOrderItemDataWithAddresses
}

func (r *sapPurchaseOrderHeaderDataWithAddressR) GetPurchaseOrderSapPurchaseOrderItemPricingElementData() SapPurchaseOrderItemPricingElementDatumSlice {
	if r == nil {
		return nil
	}
	return r.PurchaseOrderSapPurchaseOrderItemPricingElementData
}

func (r *sapPurchaseOrderHeaderDataWithAddressR) GetPurchasingDocumentSapPurchaseOrderItemScheduleLineData() SapPurchaseOrderItemScheduleLineDatumSlice {
	if r == nil {
		return nil
	}
	return r.PurchasingDocumentSapPurchaseOrderItemScheduleLineData
}
...
var (
	...
	sapPurchaseOrderHeaderDataWithAddressGeneratedColumns      = []string{}
)
...
func (o *SapPurchaseOrderHeaderDataWithAddress) PurchaseOrderSapPurchaseOrderItemAccountData(mods ...qm.QueryMod) sapPurchaseOrderItemAccountDatumQuery {
	...
	return SapPurchaseOrderItemAccountData(queryMods...)
}
...
func (o *SapPurchaseOrderHeaderDataWithAddress) PurchaseOrderSapPurchaseOrderItemDataWithAddresses(mods ...qm.QueryMod) sapPurchaseOrderItemDataWithAddressQuery {
	...
	return SapPurchaseOrderItemDataWithAddresses(queryMods...)
}
...
func (o *SapPurchaseOrderHeaderDataWithAddress) PurchaseOrderSapPurchaseOrderItemPricingElementData(mods ...qm.QueryMod) sapPurchaseOrderItemPricingElementDatumQuery {
	...
	return SapPurchaseOrderItemPricingElementData(queryMods...)
}
...
func (o *SapPurchaseOrderHeaderDataWithAddress) PurchasingDocumentSapPurchaseOrderItemScheduleLineData(mods ...qm.QueryMod) sapPurchaseOrderItemScheduleLineDatumQuery {
	...
	return SapPurchaseOrderItemScheduleLineData(queryMods...)
}
...
func SapPurchaseOrderHeaderDataWithAddresses(mods ...qm.QueryMod) sapPurchaseOrderHeaderDataWithAddressQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_order_header_data_with_address`.*"})
	}

	return sapPurchaseOrderHeaderDataWithAddressQuery{q}
}
