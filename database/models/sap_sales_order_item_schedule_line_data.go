...
func (r *sapSalesOrderItemScheduleLineDatumR) GetSalesOrderSapSalesOrderHeaderDatum() *SapSalesOrderHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapSalesOrderItemScheduleLineData(mods ...qm.QueryMod) sapSalesOrderItemScheduleLineDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_order_item_schedule_line_data`.*"})
	}

	return sapSalesOrderItemScheduleLineDatumQuery{q}
}
