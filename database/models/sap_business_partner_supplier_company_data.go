...
func (r *sapBusinessPartnerSupplierCompanyDatumR) GetSupplierSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapBusinessPartnerSupplierCompanyData(mods ...qm.QueryMod) sapBusinessPartnerSupplierCompanyDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_supplier_company_data`.*"})
	}

	return sapBusinessPartnerSupplierCompanyDatumQuery{q}
}
