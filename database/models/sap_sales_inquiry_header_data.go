...
func (r *sapSalesInquiryHeaderDatumR) GetSalesInquirySapSalesInquiryHeaderPartnerData() SapSalesInquiryHeaderPartnerDatumSlice {
	if r == nil {
		return nil
	}
	return r.SalesInquirySapSalesInquiryHeaderPartnerData
}

func (r *sapSalesInquiryHeaderDatumR) GetSalesInquirySapSalesInquiryItemData() SapSalesInquiryItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.SalesInquirySapSalesInquiryItemData
}
...
func (o *SapSalesInquiryHeaderDatum) SalesInquirySapSalesInquiryHeaderPartnerData(mods ...qm.QueryMod) sapSalesInquiryHeaderPartnerDatumQuery {
	...
	return SapSalesInquiryHeaderPartnerData(queryMods...)
}
...
func SapSalesInquiryHeaderData(mods ...qm.QueryMod) sapSalesInquiryHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_inquiry_header_data`.*"})
	}

	return sapSalesInquiryHeaderDatumQuery{q}
}
