...
func (r *sapProductionOrderComponentDatumR) GetManufacturingOrderSapProductionOrderGeneralDatum() *SapProductionOrderGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductionOrderComponentData(mods ...qm.QueryMod) sapProductionOrderComponentDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_order_component_data`.*"})
	}

	return sapProductionOrderComponentDatumQuery{q}
}
