...
func (r *sapProcessOrderConfirmationBatchCharacteristicDatumR) GetOrderIDSapProcessOrderConfirmationConfirmationDatum() *SapProcessOrderConfirmationConfirmationDatum {
	if r == nil {
		return nil
	}
	return r.OrderIDSapProcessOrderConfirmationConfirmationDatum
}
...
func (o *SapProcessOrderConfirmationBatchCharacteristicDatum) OrderIDSapProcessOrderConfirmationConfirmationDatum(mods ...qm.QueryMod) sapProcessOrderConfirmationConfirmationDatumQuery {
	...
	return SapProcessOrderConfirmationConfirmationData(queryMods...)
}
...
func SapProcessOrderConfirmationBatchCharacteristicData(mods ...qm.QueryMod) sapProcessOrderConfirmationBatchCharacteristicDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_process_order_confirmation_batch_characteristic_data`.*"})
	}

	return sapProcessOrderConfirmationBatchCharacteristicDatumQuery{q}
}
