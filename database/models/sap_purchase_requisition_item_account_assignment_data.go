...
func (r *sapPurchaseRequisitionItemAccountAssignmentDatumR) GetPurchaseRequisitionSapPurchaseRequisitionHeaderDatum() *SapPurchaseRequisitionHeaderDatum {
	if r == nil {
		return nil
	}
	return r.PurchaseRequisitionSapPurchaseRequisitionHeaderDatum
}
...
func (o *SapPurchaseRequisitionItemAccountAssignmentDatum) PurchaseRequisitionSapPurchaseRequisitionHeaderDatum(mods ...qm.QueryMod) sapPurchaseRequisitionHeaderDatumQuery {
	...
	return SapPurchaseRequisitionHeaderData(queryMods...)
}
...
func SapPurchaseRequisitionItemAccountAssignmentData(mods ...qm.QueryMod) sapPurchaseRequisitionItemAccountAssignmentDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_requisition_item_account_assignment_data`.*"})
	}

	return sapPurchaseRequisitionItemAccountAssignmentDatumQuery{q}
}
