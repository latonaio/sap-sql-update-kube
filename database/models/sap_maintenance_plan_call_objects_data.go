...
func (r *sapMaintenancePlanCallObjectsDatumR) GetMaintenancePlanSapMaintenancePlanHeaderDatum() *SapMaintenancePlanHeaderDatum {
	if r == nil {
		return nil
	}
...
var (
	...
	sapMaintenancePlanCallObjectsDatumGeneratedColumns      = []string{}
)
...
func SapMaintenancePlanCallObjectsData(mods ...qm.QueryMod) sapMaintenancePlanCallObjectsDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_plan_call_objects_data`.*"})
	}

	return sapMaintenancePlanCallObjectsDatumQuery{q}
}
