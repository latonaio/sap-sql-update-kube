...
func (r *sapPurchaseOrderItemDataWithAddressR) GetPurchaseOrderSapPurchaseOrderHeaderDataWithAddress() *SapPurchaseOrderHeaderDataWithAddress {
	if r == nil {
		return nil
	}
	return r.PurchaseOrderSapPurchaseOrderHeaderDataWithAddress
}
...
var (
	...
	sapPurchaseOrderItemDataWithAddressGeneratedColumns      = []string{}
)
...
func SapPurchaseOrderItemDataWithAddresses(mods ...qm.QueryMod) sapPurchaseOrderItemDataWithAddressQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_order_item_data_with_address`.*"})
	}

	return sapPurchaseOrderItemDataWithAddressQuery{q}
}
