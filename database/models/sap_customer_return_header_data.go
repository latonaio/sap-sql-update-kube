...
func (o *SapCustomerReturnHeaderDatum) CustomerReturnSapCustomerReturnHeaderPartnerData(mods ...qm.QueryMod) sapCustomerReturnHeaderPartnerDatumQuery {
	...
	query := SapCustomerReturnHeaderPartnerData(queryMods...)
	queries.SetFrom(query.Query, "`sap_customer_return_header_partner_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_customer_return_header_partner_data`.*"})
	}
...
func (o *SapCustomerReturnHeaderDatum) CustomerReturnSapCustomerReturnItemData(mods ...qm.QueryMod) sapCustomerReturnItemDatumQuery {
	...
	query := SapCustomerReturnItemData(queryMods...)
	queries.SetFrom(query.Query, "`sap_customer_return_item_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_customer_return_item_data`.*"})
	}
...
func (o *SapCustomerReturnHeaderDatum) CustomerReturnSapCustomerReturnItemPricingElementData(mods ...qm.QueryMod) sapCustomerReturnItemPricingElementDatumQuery {
	...
	query := SapCustomerReturnItemPricingElementData(queryMods...)
	queries.SetFrom(query.Query, "`sap_customer_return_item_pricing_element_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_customer_return_item_pricing_element_data`.*"})
	}
...
func (o *SapCustomerReturnHeaderDatum) CustomerReturnSapCustomerReturnItemProcessStepData(mods ...qm.QueryMod) sapCustomerReturnItemProcessStepDatumQuery {
	...
	query := SapCustomerReturnItemProcessStepData(queryMods...)
	queries.SetFrom(query.Query, "`sap_customer_return_item_process_step_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_customer_return_item_process_step_data`.*"})
	}
...
func (o *SapCustomerReturnHeaderDatum) CustomerReturnSapCustomerReturnItemScheduleLineData(mods ...qm.QueryMod) sapCustomerReturnItemScheduleLineDatumQuery {
	...
	query := SapCustomerReturnItemScheduleLineData(queryMods...)
	queries.SetFrom(query.Query, "`sap_customer_return_item_schedule_line_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_customer_return_item_schedule_line_data`.*"})
	}
...
func SapCustomerReturnHeaderData(mods ...qm.QueryMod) sapCustomerReturnHeaderDatumQuery {
	...
	return sapCustomerReturnHeaderDatumQuery{NewQuery(mods...)}
}
