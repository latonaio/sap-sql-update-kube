...
func (r *sapBusinessPartnerCustomerSalesAreaDatumR) GetCustomerSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapBusinessPartnerCustomerSalesAreaData(mods ...qm.QueryMod) sapBusinessPartnerCustomerSalesAreaDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_customer_sales_area_data`.*"})
	}

	return sapBusinessPartnerCustomerSalesAreaDatumQuery{q}
}
