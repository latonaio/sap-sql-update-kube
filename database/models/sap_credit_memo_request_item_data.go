...
func (r *sapCreditMemoRequestItemDatumR) GetCreditMemoRequestSapCreditMemoRequestHeaderDatum() *SapCreditMemoRequestHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapCreditMemoRequestItemData(mods ...qm.QueryMod) sapCreditMemoRequestItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_credit_memo_request_item_data`.*"})
	}

	return sapCreditMemoRequestItemDatumQuery{q}
}
