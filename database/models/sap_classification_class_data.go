...
func (r *sapClassificationClassDatumR) GetClassInternalIDSapClassificationCharacteristicData() SapClassificationCharacteristicDatumSlice {
	if r == nil {
		return nil
	}
	return r.ClassInternalIDSapClassificationCharacteristicData
}

func (r *sapClassificationClassDatumR) GetClassInternalIDSapClassificationClassDescriptionData() SapClassificationClassDescriptionDatumSlice {
	if r == nil {
		return nil
	}
	return r.ClassInternalIDSapClassificationClassDescriptionData
}
...
func (o *SapClassificationClassDatum) ClassInternalIDSapClassificationCharacteristicData(mods ...qm.QueryMod) sapClassificationCharacteristicDatumQuery {
	...
	return SapClassificationCharacteristicData(queryMods...)
}
...
func (o *SapClassificationClassDatum) ClassInternalIDSapClassificationClassDescriptionData(mods ...qm.QueryMod) sapClassificationClassDescriptionDatumQuery {
	...
	return SapClassificationClassDescriptionData(queryMods...)
}
...
func SapClassificationClassData(mods ...qm.QueryMod) sapClassificationClassDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_classification_class_data`.*"})
	}

	return sapClassificationClassDatumQuery{q}
}
