...
func (r *sapSalesSchedulingAgreementItemPricingElementDatumR) GetSalesSchedulingAgreementSapSalesSchedulingAgreementHeaderDatum() *SapSalesSchedulingAgreementHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapSalesSchedulingAgreementItemPricingElementData(mods ...qm.QueryMod) sapSalesSchedulingAgreementItemPricingElementDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_scheduling_agreement_item_pricing_element_data`.*"})
	}

	return sapSalesSchedulingAgreementItemPricingElementDatumQuery{q}
}
