...
func (r *sapMaintenanceOrderObjectListItemDatumR) GetMaintenanceOrderSapMaintenanceOrderHeaderDatum() *SapMaintenanceOrderHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapMaintenanceOrderObjectListItemData(mods ...qm.QueryMod) sapMaintenanceOrderObjectListItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_order_object_list_item_data`.*"})
	}

	return sapMaintenanceOrderObjectListItemDatumQuery{q}
}
