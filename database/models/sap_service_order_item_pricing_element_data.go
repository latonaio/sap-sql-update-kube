...
func (r *sapServiceOrderItemPricingElementDatumR) GetServiceOrderSapServiceOrderHeaderDatum() *SapServiceOrderHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapServiceOrderItemPricingElementData(mods ...qm.QueryMod) sapServiceOrderItemPricingElementDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_service_order_item_pricing_element_data`.*"})
	}

	return sapServiceOrderItemPricingElementDatumQuery{q}
}
