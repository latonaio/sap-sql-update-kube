...
func (r *sapProductMasterSalesOrganizationDatumR) GetProductSapProductMasterGeneralDatum() *SapProductMasterGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductMasterSalesOrganizationData(mods ...qm.QueryMod) sapProductMasterSalesOrganizationDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_product_master_sales_organization_data`.*"})
	}

	return sapProductMasterSalesOrganizationDatumQuery{q}
}
