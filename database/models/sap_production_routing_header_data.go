...
var (
	...
	sapProductionRoutingHeaderDatumGeneratedColumns      = []string{}
)
...
func SapProductionRoutingHeaderData(mods ...qm.QueryMod) sapProductionRoutingHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_routing_header_data`.*"})
	}

	return sapProductionRoutingHeaderDatumQuery{q}
}
