...
func (r *sapOutboundDeliveryItemDatumR) GetDeliveryDocumentSapOutboundDeliveryHeaderDatum() *SapOutboundDeliveryHeaderDatum {
	if r == nil {
		return nil
	}
	return r.DeliveryDocumentSapOutboundDeliveryHeaderDatum
}
...
func SapOutboundDeliveryItemData(mods ...qm.QueryMod) sapOutboundDeliveryItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_outbound_delivery_item_data`.*"})
	}

	return sapOutboundDeliveryItemDatumQuery{q}
}
