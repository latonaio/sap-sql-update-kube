...
func (o *SapMaintenancePlanHeaderDatum) MaintenancePlanSapMaintenancePlanCallObjectsData(mods ...qm.QueryMod) sapMaintenancePlanCallObjectsDatumQuery {
	...
	query := SapMaintenancePlanCallObjectsData(queryMods...)
	queries.SetFrom(query.Query, "`sap_maintenance_plan_call_objects_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_maintenance_plan_call_objects_data`.*"})
	}
...
func (o *SapMaintenancePlanHeaderDatum) MaintenancePlanSapMaintenancePlanItemData(mods ...qm.QueryMod) sapMaintenancePlanItemDatumQuery {
	...
	query := SapMaintenancePlanItemData(queryMods...)
	queries.SetFrom(query.Query, "`sap_maintenance_plan_item_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_maintenance_plan_item_data`.*"})
	}
...
func (o *SapMaintenancePlanHeaderDatum) MaintenancePlanSapMaintenancePlanStrategyCycleData(mods ...qm.QueryMod) sapMaintenancePlanStrategyCycleDatumQuery {
	...
	query := SapMaintenancePlanStrategyCycleData(queryMods...)
	queries.SetFrom(query.Query, "`sap_maintenance_plan_strategy_cycle_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_maintenance_plan_strategy_cycle_data`.*"})
	}
...
func SapMaintenancePlanHeaderData(mods ...qm.QueryMod) sapMaintenancePlanHeaderDatumQuery {
	...
	return sapMaintenancePlanHeaderDatumQuery{NewQuery(mods...)}
}
