...
func (r *sapSalesSchedulingAgreementItemScheduleLineDatumR) GetSalesSchedulingAgreementSapSalesSchedulingAgreementHeaderDatum() *SapSalesSchedulingAgreementHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapSalesSchedulingAgreementItemScheduleLineData(mods ...qm.QueryMod) sapSalesSchedulingAgreementItemScheduleLineDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_scheduling_agreement_item_schedule_line_data`.*"})
	}

	return sapSalesSchedulingAgreementItemScheduleLineDatumQuery{q}
}
