...
func (r *sapProductMasterProcurementDatumR) GetProductSapProductMasterGeneralDatum() *SapProductMasterGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductMasterProcurementData(mods ...qm.QueryMod) sapProductMasterProcurementDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_product_master_procurement_data`.*"})
	}

	return sapProductMasterProcurementDatumQuery{q}
}
