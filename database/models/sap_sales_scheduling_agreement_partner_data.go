...
func (r *sapSalesSchedulingAgreementPartnerDatumR) GetSalesSchedulingAgreementSapSalesSchedulingAgreementHeaderDatum() *SapSalesSchedulingAgreementHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapSalesSchedulingAgreementPartnerData(mods ...qm.QueryMod) sapSalesSchedulingAgreementPartnerDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_scheduling_agreement_partner_data`.*"})
	}

	return sapSalesSchedulingAgreementPartnerDatumQuery{q}
}
