...
func (r *sapProductMasterAccountingDatumR) GetProductSapProductMasterGeneralDatum() *SapProductMasterGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductMasterAccountingData(mods ...qm.QueryMod) sapProductMasterAccountingDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_product_master_accounting_data`.*"})
	}

	return sapProductMasterAccountingDatumQuery{q}
}
