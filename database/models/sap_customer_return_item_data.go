...
func (r *sapCustomerReturnItemDatumR) GetCustomerReturnSapCustomerReturnHeaderDatum() *SapCustomerReturnHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapCustomerReturnItemData(mods ...qm.QueryMod) sapCustomerReturnItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_customer_return_item_data`.*"})
	}

	return sapCustomerReturnItemDatumQuery{q}
}
