...
func (o *SapCreditMemoRequestHeaderDatum) CreditMemoRequestSapCreditMemoRequestHeaderPartnerData(mods ...qm.QueryMod) sapCreditMemoRequestHeaderPartnerDatumQuery {
	...
	query := SapCreditMemoRequestHeaderPartnerData(queryMods...)
	queries.SetFrom(query.Query, "`sap_credit_memo_request_header_partner_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_credit_memo_request_header_partner_data`.*"})
	}
...
func (o *SapCreditMemoRequestHeaderDatum) CreditMemoRequestSapCreditMemoRequestItemData(mods ...qm.QueryMod) sapCreditMemoRequestItemDatumQuery {
	...
	query := SapCreditMemoRequestItemData(queryMods...)
	queries.SetFrom(query.Query, "`sap_credit_memo_request_item_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_credit_memo_request_item_data`.*"})
	}
...
func (o *SapCreditMemoRequestHeaderDatum) CreditMemoRequestSapCreditMemoRequestItemPricingElementData(mods ...qm.QueryMod) sapCreditMemoRequestItemPricingElementDatumQuery {
	...
	query := SapCreditMemoRequestItemPricingElementData(queryMods...)
	queries.SetFrom(query.Query, "`sap_credit_memo_request_item_pricing_element_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_credit_memo_request_item_pricing_element_data`.*"})
	}
...
func SapCreditMemoRequestHeaderData(mods ...qm.QueryMod) sapCreditMemoRequestHeaderDatumQuery {
	...
	return sapCreditMemoRequestHeaderDatumQuery{NewQuery(mods...)}
}
