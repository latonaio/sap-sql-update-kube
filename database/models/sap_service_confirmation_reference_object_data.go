...
func (r *sapServiceConfirmationReferenceObjectDatumR) GetServiceConfirmationSapServiceConfirmationHeaderDatum() *SapServiceConfirmationHeaderDatum {
	if r == nil {
		return nil
	}
...
var (
	...
	sapServiceConfirmationReferenceObjectDatumGeneratedColumns      = []string{}
)
...
func SapServiceConfirmationReferenceObjectData(mods ...qm.QueryMod) sapServiceConfirmationReferenceObjectDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_service_confirmation_reference_object_data`.*"})
	}

	return sapServiceConfirmationReferenceObjectDatumQuery{q}
}
