...
func (r *sapReservationDocumentHeaderDatumR) GetReservationSapReservationDocumentItemData() SapReservationDocumentItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.ReservationSapReservationDocumentItemData
}
...
var (
	...
	sapReservationDocumentHeaderDatumGeneratedColumns      = []string{}
)
...
func (o *SapReservationDocumentHeaderDatum) ReservationSapReservationDocumentItemData(mods ...qm.QueryMod) sapReservationDocumentItemDatumQuery {
	...
	return SapReservationDocumentItemData(queryMods...)
}
...
func SapReservationDocumentHeaderData(mods ...qm.QueryMod) sapReservationDocumentHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_reservation_document_header_data`.*"})
	}

	return sapReservationDocumentHeaderDatumQuery{q}
}
