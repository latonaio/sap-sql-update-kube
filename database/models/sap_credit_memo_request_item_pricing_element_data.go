...
func (r *sapCreditMemoRequestItemPricingElementDatumR) GetCreditMemoRequestSapCreditMemoRequestHeaderDatum() *SapCreditMemoRequestHeaderDatum {
	if r == nil {
		return nil
	}
	return r.CreditMemoRequestSapCreditMemoRequestHeaderDatum
}
...
func (o *SapCreditMemoRequestItemPricingElementDatum) CreditMemoRequestSapCreditMemoRequestHeaderDatum(mods ...qm.QueryMod) sapCreditMemoRequestHeaderDatumQuery {
	...
	return SapCreditMemoRequestHeaderData(queryMods...)
}
...
func SapCreditMemoRequestItemPricingElementData(mods ...qm.QueryMod) sapCreditMemoRequestItemPricingElementDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_credit_memo_request_item_pricing_element_data`.*"})
	}

	return sapCreditMemoRequestItemPricingElementDatumQuery{q}
}
