...
func (r *sapProcessOrderConfirmationMaterialMovementsDatumR) GetOrderIDSapProcessOrderConfirmationConfirmationDatum() *SapProcessOrderConfirmationConfirmationDatum {
	if r == nil {
		return nil
	}
...
func SapProcessOrderConfirmationMaterialMovementsData(mods ...qm.QueryMod) sapProcessOrderConfirmationMaterialMovementsDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_process_order_confirmation_material_movements_data`.*"})
	}

	return sapProcessOrderConfirmationMaterialMovementsDatumQuery{q}
}
