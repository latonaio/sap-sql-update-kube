...
func (o *SapProcessOrderConfirmationConfirmationDatum) OrderIDSapProcessOrderConfirmationBatchCharacteristicData(mods ...qm.QueryMod) sapProcessOrderConfirmationBatchCharacteristicDatumQuery {
	...
	query := SapProcessOrderConfirmationBatchCharacteristicData(queryMods...)
	queries.SetFrom(query.Query, "`sap_process_order_confirmation_batch_characteristic_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_process_order_confirmation_batch_characteristic_data`.*"})
	}
...
func (o *SapProcessOrderConfirmationConfirmationDatum) OrderIDSapProcessOrderConfirmationMaterialMovementsData(mods ...qm.QueryMod) sapProcessOrderConfirmationMaterialMovementsDatumQuery {
	...
	query := SapProcessOrderConfirmationMaterialMovementsData(queryMods...)
	queries.SetFrom(query.Query, "`sap_process_order_confirmation_material_movements_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_process_order_confirmation_material_movements_data`.*"})
	}
...
func SapProcessOrderConfirmationConfirmationData(mods ...qm.QueryMod) sapProcessOrderConfirmationConfirmationDatumQuery {
	...
	return sapProcessOrderConfirmationConfirmationDatumQuery{NewQuery(mods...)}
}
