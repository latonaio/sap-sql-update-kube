...
func (r *sapBillingDocumentItemDatumR) GetBillingDocumentSapBillingDocumentHeaderDatum() *SapBillingDocumentHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapBillingDocumentItemData(mods ...qm.QueryMod) sapBillingDocumentItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_billing_document_item_data`.*"})
	}

	return sapBillingDocumentItemDatumQuery{q}
}
