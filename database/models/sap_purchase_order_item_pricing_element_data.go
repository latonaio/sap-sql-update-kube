...
func (r *sapPurchaseOrderItemPricingElementDatumR) GetPurchaseOrderSapPurchaseOrderHeaderDataWithAddress() *SapPurchaseOrderHeaderDataWithAddress {
	if r == nil {
		return nil
	}
...
func SapPurchaseOrderItemPricingElementData(mods ...qm.QueryMod) sapPurchaseOrderItemPricingElementDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_order_item_pricing_element_data`.*"})
	}

	return sapPurchaseOrderItemPricingElementDatumQuery{q}
}
