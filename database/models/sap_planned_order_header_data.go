...
func (r *sapPlannedOrderHeaderDatumR) GetPlannedOrderSapPlannedOrderComponentDatum() *SapPlannedOrderComponentDatum {
	if r == nil {
		return nil
	}
	return r.PlannedOrderSapPlannedOrderComponentDatum
}
...
func (o *SapPlannedOrderHeaderDatum) PlannedOrderSapPlannedOrderComponentDatum(mods ...qm.QueryMod) sapPlannedOrderComponentDatumQuery {
	...
	return SapPlannedOrderComponentData(queryMods...)
}
...
func SapPlannedOrderHeaderData(mods ...qm.QueryMod) sapPlannedOrderHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_planned_order_header_data`.*"})
	}

	return sapPlannedOrderHeaderDatumQuery{q}
}
