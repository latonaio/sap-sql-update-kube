...
func (r *sapMaintenanceNotificationHeaderDatumR) GetMaintenanceNotificationSapMaintenanceNotificationItemCauseData() SapMaintenanceNotificationItemCauseDatumSlice {
	if r == nil {
		return nil
	}
	return r.MaintenanceNotificationSapMaintenanceNotificationItemCauseData
}

func (r *sapMaintenanceNotificationHeaderDatumR) GetMaintenanceNotificationSapMaintenanceNotificationItemData() SapMaintenanceNotificationItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.MaintenanceNotificationSapMaintenanceNotificationItemData
}
...
func (o *SapMaintenanceNotificationHeaderDatum) MaintenanceNotificationSapMaintenanceNotificationItemCauseData(mods ...qm.QueryMod) sapMaintenanceNotificationItemCauseDatumQuery {
	...
	return SapMaintenanceNotificationItemCauseData(queryMods...)
}
...
func (o *SapMaintenanceNotificationHeaderDatum) MaintenanceNotificationSapMaintenanceNotificationItemData(mods ...qm.QueryMod) sapMaintenanceNotificationItemDatumQuery {
	...
	return SapMaintenanceNotificationItemData(queryMods...)
}
...
func SapMaintenanceNotificationHeaderData(mods ...qm.QueryMod) sapMaintenanceNotificationHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_notification_header_data`.*"})
	}

	return sapMaintenanceNotificationHeaderDatumQuery{q}
}
