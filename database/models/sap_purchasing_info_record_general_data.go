...
func (o *SapPurchasingInfoRecordGeneralDatum) PurchasingInfoRecordSapPurchasingInfoRecordOrganizationPlantData(mods ...qm.QueryMod) sapPurchasingInfoRecordOrganizationPlantDatumQuery {
	...
	query := SapPurchasingInfoRecordOrganizationPlantData(queryMods...)
	queries.SetFrom(query.Query, "`sap_purchasing_info_record_organization_plant_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_purchasing_info_record_organization_plant_data`.*"})
	}
...
func (o *SapPurchasingInfoRecordGeneralDatum) PurchasingInfoRecordSapPurchasingInfoRecordPricingConditionData(mods ...qm.QueryMod) sapPurchasingInfoRecordPricingConditionDatumQuery {
	...
	query := SapPurchasingInfoRecordPricingConditionData(queryMods...)
	queries.SetFrom(query.Query, "`sap_purchasing_info_record_pricing_condition_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_purchasing_info_record_pricing_condition_data`.*"})
	}
...
func (o *SapPurchasingInfoRecordGeneralDatum) PurchasingInfoRecordSapPurchasingInfoRecordPricingConditionValidityData(mods ...qm.QueryMod) sapPurchasingInfoRecordPricingConditionValidityDatumQuery {
	...
	query := SapPurchasingInfoRecordPricingConditionValidityData(queryMods...)
	queries.SetFrom(query.Query, "`sap_purchasing_info_record_pricing_condition_validity_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_purchasing_info_record_pricing_condition_validity_data`.*"})
	}
...
func SapPurchasingInfoRecordGeneralData(mods ...qm.QueryMod) sapPurchasingInfoRecordGeneralDatumQuery {
	...
	return sapPurchasingInfoRecordGeneralDatumQuery{NewQuery(mods...)}
}
