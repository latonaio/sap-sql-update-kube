...
func (r *sapSalesContractItemDatumR) GetSalesContractSapSalesContractHeaderDatum() *SapSalesContractHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapSalesContractItemData(mods ...qm.QueryMod) sapSalesContractItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_contract_item_data`.*"})
	}

	return sapSalesContractItemDatumQuery{q}
}
