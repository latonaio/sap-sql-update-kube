...
func (r *sapProductionOrderGeneralDatumR) GetManufacturingOrderSapProductionOrderComponentData() SapProductionOrderComponentDatumSlice {
	if r == nil {
		return nil
	}
	return r.ManufacturingOrderSapProductionOrderComponentData
}

func (r *sapProductionOrderGeneralDatumR) GetManufacturingOrderSapProductionOrderItemData() SapProductionOrderItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.ManufacturingOrderSapProductionOrderItemData
}

func (r *sapProductionOrderGeneralDatumR) GetManufacturingOrderSapProductionOrderOperationData() SapProductionOrderOperationDatumSlice {
	if r == nil {
		return nil
	}
	return r.ManufacturingOrderSapProductionOrderOperationData
}

func (r *sapProductionOrderGeneralDatumR) GetManufacturingOrderSapProductionOrderStatusData() SapProductionOrderStatusDatumSlice {
	if r == nil {
		return nil
	}
	return r.ManufacturingOrderSapProductionOrderStatusData
}
...
func (o *SapProductionOrderGeneralDatum) ManufacturingOrderSapProductionOrderComponentData(mods ...qm.QueryMod) sapProductionOrderComponentDatumQuery {
	...
	return SapProductionOrderComponentData(queryMods...)
}
...
func (o *SapProductionOrderGeneralDatum) ManufacturingOrderSapProductionOrderItemData(mods ...qm.QueryMod) sapProductionOrderItemDatumQuery {
	...
	return SapProductionOrderItemData(queryMods...)
}
...
func (o *SapProductionOrderGeneralDatum) ManufacturingOrderSapProductionOrderOperationData(mods ...qm.QueryMod) sapProductionOrderOperationDatumQuery {
	...
	return SapProductionOrderOperationData(queryMods...)
}
...
func (o *SapProductionOrderGeneralDatum) ManufacturingOrderSapProductionOrderStatusData(mods ...qm.QueryMod) sapProductionOrderStatusDatumQuery {
	...
	return SapProductionOrderStatusData(queryMods...)
}
...
func SapProductionOrderGeneralData(mods ...qm.QueryMod) sapProductionOrderGeneralDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_order_general_data`.*"})
	}

	return sapProductionOrderGeneralDatumQuery{q}
}
