...
func (r *sapCreditMemoRequestHeaderPartnerDatumR) GetCreditMemoRequestSapCreditMemoRequestHeaderDatum() *SapCreditMemoRequestHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapCreditMemoRequestHeaderPartnerData(mods ...qm.QueryMod) sapCreditMemoRequestHeaderPartnerDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_credit_memo_request_header_partner_data`.*"})
	}

	return sapCreditMemoRequestHeaderPartnerDatumQuery{q}
}
