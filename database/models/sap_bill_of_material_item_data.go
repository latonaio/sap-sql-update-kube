...
func (r *sapBillOfMaterialItemDatumR) GetBillOfMaterialSapBillOfMaterialHeaderDatum() *SapBillOfMaterialHeaderDatum {
	if r == nil {
		return nil
	}
	return r.BillOfMaterialSapBillOfMaterialHeaderDatum
}
...
func (o *SapBillOfMaterialItemDatum) BillOfMaterialSapBillOfMaterialHeaderDatum(mods ...qm.QueryMod) sapBillOfMaterialHeaderDatumQuery {
	...
	return SapBillOfMaterialHeaderData(queryMods...)
}
...
func SapBillOfMaterialItemData(mods ...qm.QueryMod) sapBillOfMaterialItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_bill_of_material_item_data`.*"})
	}

	return sapBillOfMaterialItemDatumQuery{q}
}
