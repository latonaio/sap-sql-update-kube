...
func (r *sapProductMasterClassProductCharacteristicDatumR) GetProductSapProductMasterClassProductGeneralDatum() *SapProductMasterClassProductGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductMasterClassProductCharacteristicData(mods ...qm.QueryMod) sapProductMasterClassProductCharacteristicDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_product_master_class_product_characteristic_data`.*"})
	}

	return sapProductMasterClassProductCharacteristicDatumQuery{q}
}
