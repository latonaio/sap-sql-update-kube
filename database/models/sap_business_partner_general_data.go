...
func (o *SapBusinessPartnerGeneralDatum) CustomerSapBusinessPartnerCustomerDatum(mods ...qm.QueryMod) sapBusinessPartnerCustomerDatumQuery {
	...
	query := SapBusinessPartnerCustomerData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_customer_data`")
...
func (o *SapBusinessPartnerGeneralDatum) SupplierSapBusinessPartnerSupplierDatum(mods ...qm.QueryMod) sapBusinessPartnerSupplierDatumQuery {
	...
	query := SapBusinessPartnerSupplierData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_supplier_data`")
...
func (o *SapBusinessPartnerGeneralDatum) BusinessPartnerSapBusinessPartnerAddressData(mods ...qm.QueryMod) sapBusinessPartnerAddressDatumQuery {
	...
	query := SapBusinessPartnerAddressData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_address_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_address_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) BusinessPartnerSapBusinessPartnerBankData(mods ...qm.QueryMod) sapBusinessPartnerBankDatumQuery {
	...
	query := SapBusinessPartnerBankData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_bank_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_bank_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) CustomerSapBusinessPartnerCustomerCompanyData(mods ...qm.QueryMod) sapBusinessPartnerCustomerCompanyDatumQuery {
	...
	query := SapBusinessPartnerCustomerCompanyData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_customer_company_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_customer_company_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) CustomerSapBusinessPartnerCustomerPartnerFunctionData(mods ...qm.QueryMod) sapBusinessPartnerCustomerPartnerFunctionDatumQuery {
	...
	query := SapBusinessPartnerCustomerPartnerFunctionData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_customer_partner_function_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_customer_partner_function_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) CustomerSapBusinessPartnerCustomerSalesAreaData(mods ...qm.QueryMod) sapBusinessPartnerCustomerSalesAreaDatumQuery {
	...
	query := SapBusinessPartnerCustomerSalesAreaData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_customer_sales_area_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_customer_sales_area_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) BusinessPartnerSapBusinessPartnerRoleData(mods ...qm.QueryMod) sapBusinessPartnerRoleDatumQuery {
	...
	query := SapBusinessPartnerRoleData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_role_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_role_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) SupplierSapBusinessPartnerSupplierCompanyData(mods ...qm.QueryMod) sapBusinessPartnerSupplierCompanyDatumQuery {
	...
	query := SapBusinessPartnerSupplierCompanyData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_supplier_company_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_supplier_company_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) SupplierSapBusinessPartnerSupplierPartnerFunctionData(mods ...qm.QueryMod) sapBusinessPartnerSupplierPartnerFunctionDatumQuery {
	...
	query := SapBusinessPartnerSupplierPartnerFunctionData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_supplier_partner_function_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_supplier_partner_function_data`.*"})
	}
...
func (o *SapBusinessPartnerGeneralDatum) SupplierSapBusinessPartnerSupplierPurchasingOrganizationData(mods ...qm.QueryMod) sapBusinessPartnerSupplierPurchasingOrganizationDatumQuery {
	...
	query := SapBusinessPartnerSupplierPurchasingOrganizationData(queryMods...)
	queries.SetFrom(query.Query, "`sap_business_partner_supplier_purchasing_organization_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_business_partner_supplier_purchasing_organization_data`.*"})
	}
...
func SapBusinessPartnerGeneralData(mods ...qm.QueryMod) sapBusinessPartnerGeneralDatumQuery {
	...
	return sapBusinessPartnerGeneralDatumQuery{NewQuery(mods...)}
}
