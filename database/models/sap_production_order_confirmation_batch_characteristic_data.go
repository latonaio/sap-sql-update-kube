...
var (
	...
	sapProductionOrderConfirmationBatchCharacteristicDatumGeneratedColumns      = []string{}
)
...
func SapProductionOrderConfirmationBatchCharacteristicData(mods ...qm.QueryMod) sapProductionOrderConfirmationBatchCharacteristicDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_order_confirmation_batch_characteristic_data`.*"})
	}

	return sapProductionOrderConfirmationBatchCharacteristicDatumQuery{q}
}
