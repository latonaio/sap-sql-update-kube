...
func (r *sapReservationDocumentItemDatumR) GetReservationSapReservationDocumentHeaderDatum() *SapReservationDocumentHeaderDatum {
	if r == nil {
		return nil
	}
	return r.ReservationSapReservationDocumentHeaderDatum
}
...
func (o *SapReservationDocumentItemDatum) ReservationSapReservationDocumentHeaderDatum(mods ...qm.QueryMod) sapReservationDocumentHeaderDatumQuery {
	...
	return SapReservationDocumentHeaderData(queryMods...)
}
...
func SapReservationDocumentItemData(mods ...qm.QueryMod) sapReservationDocumentItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_reservation_document_item_data`.*"})
	}

	return sapReservationDocumentItemDatumQuery{q}
}
