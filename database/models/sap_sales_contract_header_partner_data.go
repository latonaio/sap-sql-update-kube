...
func (r *sapSalesContractHeaderPartnerDatumR) GetSalesContractSapSalesContractHeaderDatum() *SapSalesContractHeaderDatum {
	if r == nil {
		return nil
	}
...
var (
	...
	sapSalesContractHeaderPartnerDatumGeneratedColumns      = []string{}
)
...
func SapSalesContractHeaderPartnerData(mods ...qm.QueryMod) sapSalesContractHeaderPartnerDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_contract_header_partner_data`.*"})
	}

	return sapSalesContractHeaderPartnerDatumQuery{q}
}
