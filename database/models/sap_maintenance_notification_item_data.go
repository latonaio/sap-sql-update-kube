...
func (r *sapMaintenanceNotificationItemDatumR) GetMaintenanceNotificationSapMaintenanceNotificationHeaderDatum() *SapMaintenanceNotificationHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapMaintenanceNotificationItemData(mods ...qm.QueryMod) sapMaintenanceNotificationItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_notification_item_data`.*"})
	}

	return sapMaintenanceNotificationItemDatumQuery{q}
}
