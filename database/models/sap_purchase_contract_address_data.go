...
func (r *sapPurchaseContractAddressDatumR) GetPurchaseContractSapPurchaseContractHeaderDatum() *SapPurchaseContractHeaderDatum {
	if r == nil {
		return nil
	}
	return r.PurchaseContractSapPurchaseContractHeaderDatum
}
...
var (
	...
	sapPurchaseContractAddressDatumGeneratedColumns      = []string{}
)
...
func (o *SapPurchaseContractAddressDatum) PurchaseContractSapPurchaseContractHeaderDatum(mods ...qm.QueryMod) sapPurchaseContractHeaderDatumQuery {
	...
	return SapPurchaseContractHeaderData(queryMods...)
}
...
func SapPurchaseContractAddressData(mods ...qm.QueryMod) sapPurchaseContractAddressDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_contract_address_data`.*"})
	}

	return sapPurchaseContractAddressDatumQuery{q}
}
