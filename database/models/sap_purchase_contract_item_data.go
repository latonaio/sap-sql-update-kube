...
func (r *sapPurchaseContractItemDatumR) GetPurchaseContractSapPurchaseContractHeaderDatum() *SapPurchaseContractHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapPurchaseContractItemData(mods ...qm.QueryMod) sapPurchaseContractItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_contract_item_data`.*"})
	}

	return sapPurchaseContractItemDatumQuery{q}
}
