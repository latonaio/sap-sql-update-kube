...
func (r *sapServiceOrderItemDatumR) GetServiceOrderSapServiceOrderHeaderDatum() *SapServiceOrderHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapServiceOrderItemData(mods ...qm.QueryMod) sapServiceOrderItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_service_order_item_data`.*"})
	}

	return sapServiceOrderItemDatumQuery{q}
}
