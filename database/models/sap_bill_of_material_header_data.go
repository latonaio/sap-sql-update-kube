...
func (r *sapBillOfMaterialHeaderDatumR) GetBillOfMaterialSapBillOfMaterialItemData() SapBillOfMaterialItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.BillOfMaterialSapBillOfMaterialItemData
}
...
var (
	...
	sapBillOfMaterialHeaderDatumGeneratedColumns      = []string{}
)
...
func (o *SapBillOfMaterialHeaderDatum) BillOfMaterialSapBillOfMaterialItemData(mods ...qm.QueryMod) sapBillOfMaterialItemDatumQuery {
	...
	return SapBillOfMaterialItemData(queryMods...)
}
...
func SapBillOfMaterialHeaderData(mods ...qm.QueryMod) sapBillOfMaterialHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_bill_of_material_header_data`.*"})
	}

	return sapBillOfMaterialHeaderDatumQuery{q}
}
