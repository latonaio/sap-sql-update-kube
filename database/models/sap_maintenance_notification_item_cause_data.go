...
func (r *sapMaintenanceNotificationItemCauseDatumR) GetMaintenanceNotificationSapMaintenanceNotificationHeaderDatum() *SapMaintenanceNotificationHeaderDatum {
	if r == nil {
		return nil
	}
	return r.MaintenanceNotificationSapMaintenanceNotificationHeaderDatum
}
...
func (o *SapMaintenanceNotificationItemCauseDatum) MaintenanceNotificationSapMaintenanceNotificationHeaderDatum(mods ...qm.QueryMod) sapMaintenanceNotificationHeaderDatumQuery {
	...
	return SapMaintenanceNotificationHeaderData(queryMods...)
}
...
func SapMaintenanceNotificationItemCauseData(mods ...qm.QueryMod) sapMaintenanceNotificationItemCauseDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_notification_item_cause_data`.*"})
	}

	return sapMaintenanceNotificationItemCauseDatumQuery{q}
}
