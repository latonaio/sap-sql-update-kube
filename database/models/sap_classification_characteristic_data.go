...
func (r *sapClassificationCharacteristicDatumR) GetClassInternalIDSapClassificationClassDatum() *SapClassificationClassDatum {
	if r == nil {
		return nil
	}
...
func SapClassificationCharacteristicData(mods ...qm.QueryMod) sapClassificationCharacteristicDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_classification_characteristic_data`.*"})
	}

	return sapClassificationCharacteristicDatumQuery{q}
}
