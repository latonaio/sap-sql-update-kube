...
func (r *sapMaintenanceOrderHeaderDatumR) GetMaintenanceOrderSapMaintenanceOrderObjectListItemData() SapMaintenanceOrderObjectListItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.MaintenanceOrderSapMaintenanceOrderObjectListItemData
}

func (r *sapMaintenanceOrderHeaderDatumR) GetMaintenanceOrderSapMaintenanceOrderOperationComponentData() SapMaintenanceOrderOperationComponentDatumSlice {
	if r == nil {
		return nil
	}
	return r.MaintenanceOrderSapMaintenanceOrderOperationComponentData
}

func (r *sapMaintenanceOrderHeaderDatumR) GetMaintenanceOrderSapMaintenanceOrderOperationData() SapMaintenanceOrderOperationDatumSlice {
	if r == nil {
		return nil
	}
	return r.MaintenanceOrderSapMaintenanceOrderOperationData
}
...
var (
	...
	sapMaintenanceOrderHeaderDatumGeneratedColumns      = []string{}
)
...
func (o *SapMaintenanceOrderHeaderDatum) MaintenanceOrderSapMaintenanceOrderObjectListItemData(mods ...qm.QueryMod) sapMaintenanceOrderObjectListItemDatumQuery {
	...
	return SapMaintenanceOrderObjectListItemData(queryMods...)
}
...
func (o *SapMaintenanceOrderHeaderDatum) MaintenanceOrderSapMaintenanceOrderOperationComponentData(mods ...qm.QueryMod) sapMaintenanceOrderOperationComponentDatumQuery {
	...
	return SapMaintenanceOrderOperationComponentData(queryMods...)
}
...
func (o *SapMaintenanceOrderHeaderDatum) MaintenanceOrderSapMaintenanceOrderOperationData(mods ...qm.QueryMod) sapMaintenanceOrderOperationDatumQuery {
	...
	return SapMaintenanceOrderOperationData(queryMods...)
}
...
func SapMaintenanceOrderHeaderData(mods ...qm.QueryMod) sapMaintenanceOrderHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_order_header_data`.*"})
	}

	return sapMaintenanceOrderHeaderDatumQuery{q}
}
