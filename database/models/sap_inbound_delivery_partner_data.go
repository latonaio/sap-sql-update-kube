...
func (r *sapInboundDeliveryPartnerDatumR) GetSDDocumentSapInboundDeliveryHeaderDatum() *SapInboundDeliveryHeaderDatum {
	if r == nil {
		return nil
	}
	return r.SDDocumentSapInboundDeliveryHeaderDatum
}
...
func SapInboundDeliveryPartnerData(mods ...qm.QueryMod) sapInboundDeliveryPartnerDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_inbound_delivery_partner_data`.*"})
	}

	return sapInboundDeliveryPartnerDatumQuery{q}
}
