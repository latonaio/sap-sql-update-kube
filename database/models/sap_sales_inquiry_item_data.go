...
func (r *sapSalesInquiryItemDatumR) GetSalesInquirySapSalesInquiryHeaderDatum() *SapSalesInquiryHeaderDatum {
	if r == nil {
		return nil
	}
...
func (r *sapSalesInquiryItemDatumR) GetSalesInquirySapSalesInquiryItemPricingElementData() SapSalesInquiryItemPricingElementDatumSlice {
	if r == nil {
		return nil
	}
	return r.SalesInquirySapSalesInquiryItemPricingElementData
}
...
func (o *SapSalesInquiryItemDatum) SalesInquirySapSalesInquiryItemPricingElementData(mods ...qm.QueryMod) sapSalesInquiryItemPricingElementDatumQuery {
	...
	return SapSalesInquiryItemPricingElementData(queryMods...)
}
...
func SapSalesInquiryItemData(mods ...qm.QueryMod) sapSalesInquiryItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_sales_inquiry_item_data`.*"})
	}

	return sapSalesInquiryItemDatumQuery{q}
}
