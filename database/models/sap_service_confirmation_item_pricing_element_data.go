...
func (r *sapServiceConfirmationItemPricingElementDatumR) GetServiceConfirmationSapServiceConfirmationItemDatum() *SapServiceConfirmationItemDatum {
	if r == nil {
		return nil
	}
	return r.ServiceConfirmationSapServiceConfirmationItemDatum
}
...
func SapServiceConfirmationItemPricingElementData(mods ...qm.QueryMod) sapServiceConfirmationItemPricingElementDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_service_confirmation_item_pricing_element_data`.*"})
	}

	return sapServiceConfirmationItemPricingElementDatumQuery{q}
}
