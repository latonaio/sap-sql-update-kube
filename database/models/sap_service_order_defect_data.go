...
func (r *sapServiceOrderDefectDatumR) GetServiceOrderSapServiceOrderHeaderDatum() *SapServiceOrderHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapServiceOrderDefectData(mods ...qm.QueryMod) sapServiceOrderDefectDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_service_order_defect_data`.*"})
	}

	return sapServiceOrderDefectDatumQuery{q}
}
