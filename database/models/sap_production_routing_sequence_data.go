...
var (
	...
	sapProductionRoutingSequenceDatumGeneratedColumns      = []string{}
)
...
func SapProductionRoutingSequenceData(mods ...qm.QueryMod) sapProductionRoutingSequenceDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_production_routing_sequence_data`.*"})
	}

	return sapProductionRoutingSequenceDatumQuery{q}
}
