...
func (r *sapProductMasterMRPAreaDatumR) GetProductSapProductMasterGeneralDatum() *SapProductMasterGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductMasterMRPAreaData(mods ...qm.QueryMod) sapProductMasterMRPAreaDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_product_master_mrp_area_data`.*"})
	}

	return sapProductMasterMRPAreaDatumQuery{q}
}
