...
func (o *SapServiceConfirmationItemDatum) ServiceConfirmationSapServiceConfirmationItemPricingElementData(mods ...qm.QueryMod) sapServiceConfirmationItemPricingElementDatumQuery {
	...
	query := SapServiceConfirmationItemPricingElementData(queryMods...)
	queries.SetFrom(query.Query, "`sap_service_confirmation_item_pricing_element_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_service_confirmation_item_pricing_element_data`.*"})
	}
...
func SapServiceConfirmationItemData(mods ...qm.QueryMod) sapServiceConfirmationItemDatumQuery {
	...
	return sapServiceConfirmationItemDatumQuery{NewQuery(mods...)}
}
