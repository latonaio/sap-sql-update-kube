...
func (r *sapPurchaseContractItemConditionDatumR) GetPurchaseContractSapPurchaseContractHeaderDatum() *SapPurchaseContractHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapPurchaseContractItemConditionData(mods ...qm.QueryMod) sapPurchaseContractItemConditionDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchase_contract_item_condition_data`.*"})
	}

	return sapPurchaseContractItemConditionDatumQuery{q}
}
