...
func (r *sapCharacteristicCharcDescriptionDatumR) GetCharcInternalIDSapCharacteristicCharacteristicDatum() *SapCharacteristicCharacteristicDatum {
	if r == nil {
		return nil
	}
...
func SapCharacteristicCharcDescriptionData(mods ...qm.QueryMod) sapCharacteristicCharcDescriptionDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_characteristic_charc_description_data`.*"})
	}

	return sapCharacteristicCharcDescriptionDatumQuery{q}
}
