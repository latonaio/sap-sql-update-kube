...
func (r *sapBusinessPartnerCustomerDatumR) GetCustomerSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapBusinessPartnerCustomerData(mods ...qm.QueryMod) sapBusinessPartnerCustomerDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_customer_data`.*"})
	}

	return sapBusinessPartnerCustomerDatumQuery{q}
}
