...
func (r *sapPlannedOrderComponentDatumR) GetPlannedOrderSapPlannedOrderHeaderDatum() *SapPlannedOrderHeaderDatum {
	if r == nil {
		return nil
	}
	return r.PlannedOrderSapPlannedOrderHeaderDatum
}
...
func (o *SapPlannedOrderComponentDatum) PlannedOrderSapPlannedOrderHeaderDatum(mods ...qm.QueryMod) sapPlannedOrderHeaderDatumQuery {
	...
	return SapPlannedOrderHeaderData(queryMods...)
}
...
func SapPlannedOrderComponentData(mods ...qm.QueryMod) sapPlannedOrderComponentDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_planned_order_component_data`.*"})
	}

	return sapPlannedOrderComponentDatumQuery{q}
}
