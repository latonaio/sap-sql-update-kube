...
func (r *sapMaintenancePlanStrategyCycleDatumR) GetMaintenancePlanSapMaintenancePlanHeaderDatum() *SapMaintenancePlanHeaderDatum {
	if r == nil {
		return nil
	}
	return r.MaintenancePlanSapMaintenancePlanHeaderDatum
}
...
var (
	...
	sapMaintenancePlanStrategyCycleDatumGeneratedColumns      = []string{}
)
...
func (o *SapMaintenancePlanStrategyCycleDatum) MaintenancePlanSapMaintenancePlanHeaderDatum(mods ...qm.QueryMod) sapMaintenancePlanHeaderDatumQuery {
	...
	return SapMaintenancePlanHeaderData(queryMods...)
}
...
func SapMaintenancePlanStrategyCycleData(mods ...qm.QueryMod) sapMaintenancePlanStrategyCycleDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_plan_strategy_cycle_data`.*"})
	}

	return sapMaintenancePlanStrategyCycleDatumQuery{q}
}
