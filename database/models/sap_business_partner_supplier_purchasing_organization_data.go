...
func (r *sapBusinessPartnerSupplierPurchasingOrganizationDatumR) GetSupplierSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapBusinessPartnerSupplierPurchasingOrganizationData(mods ...qm.QueryMod) sapBusinessPartnerSupplierPurchasingOrganizationDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_supplier_purchasing_organization_data`.*"})
	}

	return sapBusinessPartnerSupplierPurchasingOrganizationDatumQuery{q}
}
