...
func (r *sapPurchasingInfoRecordOrganizationPlantDatumR) GetPurchasingInfoRecordSapPurchasingInfoRecordGeneralDatum() *SapPurchasingInfoRecordGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapPurchasingInfoRecordOrganizationPlantData(mods ...qm.QueryMod) sapPurchasingInfoRecordOrganizationPlantDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchasing_info_record_organization_plant_data`.*"})
	}

	return sapPurchasingInfoRecordOrganizationPlantDatumQuery{q}
}
