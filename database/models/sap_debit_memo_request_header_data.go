...
func (o *SapDebitMemoRequestHeaderDatum) DebitMemoRequestSapDebitMemoRequestHeaderPartnerData(mods ...qm.QueryMod) sapDebitMemoRequestHeaderPartnerDatumQuery {
	...
	query := SapDebitMemoRequestHeaderPartnerData(queryMods...)
	queries.SetFrom(query.Query, "`sap_debit_memo_request_header_partner_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_debit_memo_request_header_partner_data`.*"})
	}
...
func (o *SapDebitMemoRequestHeaderDatum) DebitMemoRequestSapDebitMemoRequestItemData(mods ...qm.QueryMod) sapDebitMemoRequestItemDatumQuery {
	...
	query := SapDebitMemoRequestItemData(queryMods...)
	queries.SetFrom(query.Query, "`sap_debit_memo_request_item_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_debit_memo_request_item_data`.*"})
	}
...
func (o *SapDebitMemoRequestHeaderDatum) DebitMemoRequestSapDebitMemoRequestItemPricingElementData(mods ...qm.QueryMod) sapDebitMemoRequestItemPricingElementDatumQuery {
	...
	query := SapDebitMemoRequestItemPricingElementData(queryMods...)
	queries.SetFrom(query.Query, "`sap_debit_memo_request_item_pricing_element_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_debit_memo_request_item_pricing_element_data`.*"})
	}
...
func SapDebitMemoRequestHeaderData(mods ...qm.QueryMod) sapDebitMemoRequestHeaderDatumQuery {
	...
	return sapDebitMemoRequestHeaderDatumQuery{NewQuery(mods...)}
}
