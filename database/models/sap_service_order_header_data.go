...
func (r *sapServiceOrderHeaderDatumR) GetServiceOrderSapServiceOrderConfirmationDatum() *SapServiceOrderConfirmationDatum {
	if r == nil {
		return nil
	}
	return r.ServiceOrderSapServiceOrderConfirmationDatum
}

func (r *sapServiceOrderHeaderDatumR) GetServiceOrderSapServiceOrderPersonResponsibleDatum() *SapServiceOrderPersonResponsibleDatum {
	if r == nil {
		return nil
	}
	return r.ServiceOrderSapServiceOrderPersonResponsibleDatum
}

func (r *sapServiceOrderHeaderDatumR) GetServiceOrderSapServiceOrderReferenceObjectDatum() *SapServiceOrderReferenceObjectDatum {
	if r == nil {
		return nil
	}
	return r.ServiceOrderSapServiceOrderReferenceObjectDatum
}

func (r *sapServiceOrderHeaderDatumR) GetServiceOrderSapServiceOrderDefectData() SapServiceOrderDefectDatumSlice {
	if r == nil {
		return nil
	}
	return r.ServiceOrderSapServiceOrderDefectData
}

func (r *sapServiceOrderHeaderDatumR) GetServiceOrderSapServiceOrderItemData() SapServiceOrderItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.ServiceOrderSapServiceOrderItemData
}

func (r *sapServiceOrderHeaderDatumR) GetServiceOrderSapServiceOrderItemPricingElementData() SapServiceOrderItemPricingElementDatumSlice {
	if r == nil {
		return nil
	}
	return r.ServiceOrderSapServiceOrderItemPricingElementData
}
...
func (o *SapServiceOrderHeaderDatum) ServiceOrderSapServiceOrderConfirmationDatum(mods ...qm.QueryMod) sapServiceOrderConfirmationDatumQuery {
	...
	return SapServiceOrderConfirmationData(queryMods...)
}
...
func (o *SapServiceOrderHeaderDatum) ServiceOrderSapServiceOrderPersonResponsibleDatum(mods ...qm.QueryMod) sapServiceOrderPersonResponsibleDatumQuery {
	...
	return SapServiceOrderPersonResponsibleData(queryMods...)
}
...
func (o *SapServiceOrderHeaderDatum) ServiceOrderSapServiceOrderReferenceObjectDatum(mods ...qm.QueryMod) sapServiceOrderReferenceObjectDatumQuery {
	...
	return SapServiceOrderReferenceObjectData(queryMods...)
}
...
func (o *SapServiceOrderHeaderDatum) ServiceOrderSapServiceOrderDefectData(mods ...qm.QueryMod) sapServiceOrderDefectDatumQuery {
	...
	return SapServiceOrderDefectData(queryMods...)
}
...
func (o *SapServiceOrderHeaderDatum) ServiceOrderSapServiceOrderItemData(mods ...qm.QueryMod) sapServiceOrderItemDatumQuery {
	...
	return SapServiceOrderItemData(queryMods...)
}
...
func (o *SapServiceOrderHeaderDatum) ServiceOrderSapServiceOrderItemPricingElementData(mods ...qm.QueryMod) sapServiceOrderItemPricingElementDatumQuery {
	...
	return SapServiceOrderItemPricingElementData(queryMods...)
}
...
func SapServiceOrderHeaderData(mods ...qm.QueryMod) sapServiceOrderHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_service_order_header_data`.*"})
	}

	return sapServiceOrderHeaderDatumQuery{q}
}
