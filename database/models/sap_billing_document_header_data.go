...
func (r *sapBillingDocumentHeaderDatumR) GetBillingDocumentSapBillingDocumentHeaderPartnerData() SapBillingDocumentHeaderPartnerDatumSlice {
	if r == nil {
		return nil
	}
	return r.BillingDocumentSapBillingDocumentHeaderPartnerData
}

func (r *sapBillingDocumentHeaderDatumR) GetBillingDocumentSapBillingDocumentItemData() SapBillingDocumentItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.BillingDocumentSapBillingDocumentItemData
}

func (r *sapBillingDocumentHeaderDatumR) GetBillingDocumentSapBillingDocumentItemPartnerData() SapBillingDocumentItemPartnerDatumSlice {
	if r == nil {
		return nil
	}
	return r.BillingDocumentSapBillingDocumentItemPartnerData
}

func (r *sapBillingDocumentHeaderDatumR) GetBillingDocumentSapBillingDocumentItemPricingElementData() SapBillingDocumentItemPricingElementDatumSlice {
	if r == nil {
		return nil
	}
	return r.BillingDocumentSapBillingDocumentItemPricingElementData
}
...
func (o *SapBillingDocumentHeaderDatum) BillingDocumentSapBillingDocumentHeaderPartnerData(mods ...qm.QueryMod) sapBillingDocumentHeaderPartnerDatumQuery {
	...
	return SapBillingDocumentHeaderPartnerData(queryMods...)
}
...
func (o *SapBillingDocumentHeaderDatum) BillingDocumentSapBillingDocumentItemData(mods ...qm.QueryMod) sapBillingDocumentItemDatumQuery {
	...
	return SapBillingDocumentItemData(queryMods...)
}
...
func (o *SapBillingDocumentHeaderDatum) BillingDocumentSapBillingDocumentItemPartnerData(mods ...qm.QueryMod) sapBillingDocumentItemPartnerDatumQuery {
	...
	return SapBillingDocumentItemPartnerData(queryMods...)
}
...
func (o *SapBillingDocumentHeaderDatum) BillingDocumentSapBillingDocumentItemPricingElementData(mods ...qm.QueryMod) sapBillingDocumentItemPricingElementDatumQuery {
	...
	return SapBillingDocumentItemPricingElementData(queryMods...)
}
...
func SapBillingDocumentHeaderData(mods ...qm.QueryMod) sapBillingDocumentHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_billing_document_header_data`.*"})
	}

	return sapBillingDocumentHeaderDatumQuery{q}
}
