...
func (r *sapPurchasingInfoRecordPricingConditionValidityDatumR) GetPurchasingInfoRecordSapPurchasingInfoRecordGeneralDatum() *SapPurchasingInfoRecordGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapPurchasingInfoRecordPricingConditionValidityData(mods ...qm.QueryMod) sapPurchasingInfoRecordPricingConditionValidityDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_purchasing_info_record_pricing_condition_validity_data`.*"})
	}

	return sapPurchasingInfoRecordPricingConditionValidityDatumQuery{q}
}
