...
func (r *sapProductMasterPlantDatumR) GetProductSapProductMasterGeneralDatum() *SapProductMasterGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapProductMasterPlantData(mods ...qm.QueryMod) sapProductMasterPlantDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_product_master_plant_data`.*"})
	}

	return sapProductMasterPlantDatumQuery{q}
}
