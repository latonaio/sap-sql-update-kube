...
func (r *sapClassificationClassDescriptionDatumR) GetClassInternalIDSapClassificationClassDatum() *SapClassificationClassDatum {
	if r == nil {
		return nil
	}
	return r.ClassInternalIDSapClassificationClassDatum
}
...
func (o *SapClassificationClassDescriptionDatum) ClassInternalIDSapClassificationClassDatum(mods ...qm.QueryMod) sapClassificationClassDatumQuery {
	...
	return SapClassificationClassData(queryMods...)
}
...
func SapClassificationClassDescriptionData(mods ...qm.QueryMod) sapClassificationClassDescriptionDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_classification_class_description_data`.*"})
	}

	return sapClassificationClassDescriptionDatumQuery{q}
}
