...
func (r *sapMaintenancePlanItemDatumR) GetMaintenancePlanSapMaintenancePlanHeaderDatum() *SapMaintenancePlanHeaderDatum {
	if r == nil {
		return nil
	}
...
func SapMaintenancePlanItemData(mods ...qm.QueryMod) sapMaintenancePlanItemDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_maintenance_plan_item_data`.*"})
	}

	return sapMaintenancePlanItemDatumQuery{q}
}
