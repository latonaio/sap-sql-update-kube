...
func (r *sapServiceConfirmationHeaderDatumR) GetServiceConfirmationSapServiceConfirmationPersonResponsibleDatum() *SapServiceConfirmationPersonResponsibleDatum {
	if r == nil {
		return nil
	}
	return r.ServiceConfirmationSapServiceConfirmationPersonResponsibleDatum
}

func (r *sapServiceConfirmationHeaderDatumR) GetServiceConfirmationSapServiceConfirmationReferenceObjectDatum() *SapServiceConfirmationReferenceObjectDatum {
	if r == nil {
		return nil
	}
	return r.ServiceConfirmationSapServiceConfirmationReferenceObjectDatum
}

func (r *sapServiceConfirmationHeaderDatumR) GetServiceConfirmationSapServiceConfirmationItemData() SapServiceConfirmationItemDatumSlice {
	if r == nil {
		return nil
	}
	return r.ServiceConfirmationSapServiceConfirmationItemData
}
...
var (
	...
	sapServiceConfirmationHeaderDatumGeneratedColumns      = []string{}
)
...
func (o *SapServiceConfirmationHeaderDatum) ServiceConfirmationSapServiceConfirmationPersonResponsibleDatum(mods ...qm.QueryMod) sapServiceConfirmationPersonResponsibleDatumQuery {
	...
	return SapServiceConfirmationPersonResponsibleData(queryMods...)
}
...
func (o *SapServiceConfirmationHeaderDatum) ServiceConfirmationSapServiceConfirmationReferenceObjectDatum(mods ...qm.QueryMod) sapServiceConfirmationReferenceObjectDatumQuery {
	...
	return SapServiceConfirmationReferenceObjectData(queryMods...)
}
...
func (o *SapServiceConfirmationHeaderDatum) ServiceConfirmationSapServiceConfirmationItemData(mods ...qm.QueryMod) sapServiceConfirmationItemDatumQuery {
	...
	return SapServiceConfirmationItemData(queryMods...)
}
...
func SapServiceConfirmationHeaderData(mods ...qm.QueryMod) sapServiceConfirmationHeaderDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_service_confirmation_header_data`.*"})
	}

	return sapServiceConfirmationHeaderDatumQuery{q}
}
