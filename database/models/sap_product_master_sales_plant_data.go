...
func (r *sapProductMasterSalesPlantDatumR) GetProductSapProductMasterGeneralDatum() *SapProductMasterGeneralDatum {
	if r == nil {
		return nil
	}
...
var (
	...
	sapProductMasterSalesPlantDatumGeneratedColumns      = []string{}
)
...
func SapProductMasterSalesPlantData(mods ...qm.QueryMod) sapProductMasterSalesPlantDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_product_master_sales_plant_data`.*"})
	}

	return sapProductMasterSalesPlantDatumQuery{q}
}
