...
func (o *SapEquipmentMasterEquipmentDatum) EquipmentSapEquipmentMasterBusinessPartnerData(mods ...qm.QueryMod) sapEquipmentMasterBusinessPartnerDatumQuery {
	...
	query := SapEquipmentMasterBusinessPartnerData(queryMods...)
	queries.SetFrom(query.Query, "`sap_equipment_master_business_partner_data`")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"`sap_equipment_master_business_partner_data`.*"})
	}
...
func SapEquipmentMasterEquipmentData(mods ...qm.QueryMod) sapEquipmentMasterEquipmentDatumQuery {
	...
	return sapEquipmentMasterEquipmentDatumQuery{NewQuery(mods...)}
}
