...
func (r *sapBusinessPartnerCustomerPartnerFunctionDatumR) GetCustomerSapBusinessPartnerGeneralDatum() *SapBusinessPartnerGeneralDatum {
	if r == nil {
		return nil
	}
...
func SapBusinessPartnerCustomerPartnerFunctionData(mods ...qm.QueryMod) sapBusinessPartnerCustomerPartnerFunctionDatumQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`sap_business_partner_customer_partner_function_data`.*"})
	}

	return sapBusinessPartnerCustomerPartnerFunctionDatumQuery{q}
}
